...
@SpringBootTest
public class JITRPositionsServiceTest 
{
    @Autowired
    ...
    @Test
    public void testFindJITRPositionsByJITRNumberWithValidJITRNumber()
    {
        int jitrNumber = 100;
    ...
    @Test
    public void testFindJITRPositionsByJITRNumberwithInvalidJITRNumber()
    {
        int jitrNumber = -100;
    ...
    @Test
    public void testSaveJITRPosition()
    {
